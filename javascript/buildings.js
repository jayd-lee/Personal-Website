...
tl.fromTo("#greentruck", 13, {x:-280, repeat:0, transformOrigin:"50% 50%"}, {x:200, transformOrigin:"50% 50%", delay:0, ease: Expo.easeInOut})
.to("#greentruck", 2.3, {delay:2, x:50, ease:Elastic.easeInOut, yoyo:true, repeat:-1, repeatDelay:4})
...
TweenMax.fromTo("#Mixer", 12, {delay:3, x:750, repeat:0, transformOrigin:"50% 50%", repeat:-1, yoyo:true}, {x:0, transformOrigin:"50% 50%", delay:0, ease: Sine.easeInOut, repeat:-1, yoyo:true, delay:2, repeatDelay:9});
